...
if __name__ == '__main__':
    ...
    players = []
    players.append(Player(name=input('Введите Ваше имя: '), is_ai=False, auto_ship=True, skill=1))
    ...
    while True:
        ...
        if game.status == 'in game':
            ...
            Game.clear_screen()
            game.current_player.message.append("Введите координаты удара: ")
            game.draw()
        ...
        if game.status == 'game over':
            ...
            print('Поздравляем, {} выиграл матч! '.format(game.current_player.name))
            break
